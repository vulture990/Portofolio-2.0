        ...
        <li className="">
          <h2 className="flex flex-row text-left text-paragraph  font-display text-lg sm:text-2xl  font-normal  italic">
            <div className="w-10">
              <img
                src="../play.png"
                alt=" play league of legends w.o.w "
                width={100}
                height={100}
              />
            </div>
        ...
        <li className="">
          <h2 className="flex flex-row text-left text-paragraph  font-display text-lg sm:text-2xl  font-normal  italic">
            <div className="w-10">
              <img
                src="../book.png"
                alt="vulture salbi psychology books philosophy width={100} height={100}  "
              />
            </div>
            Reading
          </h2>
        ...
        <li>
          <h2 className="flex flex-row text-left text-paragraph  font-display text-lg sm:text-2xl  font-normal  italic">
            <div className="w-56">
              <img
                src="../read.svg"
                alt="vulture salbi psychology philosophy "
                width={100}
                height={100}
              />
            </div>
